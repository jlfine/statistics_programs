...
random variable, which may be a parameter of interest, deviates from some value. For instance, we
may wish to know the probability that our parameter $\theta$ is larger than some positive value $k$.

Two inequalities are used to compute these values: Markov's inequality and Chebyshev's inequality. We will derive Markov's 
